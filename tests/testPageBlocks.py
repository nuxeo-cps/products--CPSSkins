...
class TestPageBlocks(CPSSkinsTestCase.CPSSkinsTestCase):
    ...
    def test_moveCell_right(self):
        ...
        self.assert_(pageblock.getObjects()[0]['templets'] == [])
        ...
        self.assert_(pageblock.getObjects()[1]['templets'] == [templet])
    ...
    def test_moveCell_left(self):
        ...
        self.assert_(pageblock.getObjects()[1]['templets'] == [])
        ...
        self.assert_(pageblock.getObjects()[0]['templets'] == [templet])
